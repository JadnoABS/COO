...
public class GameController {
  ...
  /**
   * Verifica se o Pacman colidiu com algum Ghost mortal ou uma fruta e adiciona
   * os pontos e vidas necessarios para a logica do jogo
   *
   * @param elements
   * @param pacman
   */
  private void checkPacmanEatSomeOneAndOrTimeFruittoDesappear(ArrayList<Element> elements, Pacman pacman) {
    ...
    for (int i = 1; i < elements.size(); i++) {
      ...
      if (pacman.overlap(eTemp)) {
        ...
        // PACMAN GANHA VIDA COM 4000 PONTOS (foi a pontuacao mais viavel que encontramos para o pacman ganhar vida, 10000 era muito e 1000 era pouco)
  ...
  /**
   * Reproduz o efeito sonoro do power pellet
   */
  public void audioPowerPellet() {
    try {
      // URL do som
  ...
  /**
   * Reproduz o efeito sonoro da morte do ghost
   */
  public void audioGhostComido() {
    try {
      // URL do som
